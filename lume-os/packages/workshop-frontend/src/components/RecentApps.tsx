    ...
    return (
      <section className="w-full max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-medium text-kumo-default">Espaços recentes</h2>
        </div>
    ...
    return (
      <section className="w-full max-w-2xl mx-auto">
        <div className="text-center py-8 text-sm text-kumo-danger">
          Não foi possível carregar seus espaços. Verifique sua conexão e recarregue a página.
        </div>
      </section>
    )
  }
    ...
    return (
      <section className="w-full max-w-2xl mx-auto">
        <div className="text-center py-8 text-kumo-inactive text-sm">
          Nenhum espaço ainda. Crie o primeiro acima!
        </div>
      </section>
    )
  }
