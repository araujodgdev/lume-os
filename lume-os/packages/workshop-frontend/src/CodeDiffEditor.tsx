  ...
  if (!filename || (!originalYText && !modifiedYText)) {
    return (
      <div
        ...
        style={{ height }}
      >
        {!filename ? 'Selecione um arquivo para ver as alterações' : 'Carregando diferenças…'}
      </div>
    )
  }
        ...
        <div className="absolute right-3 top-3 flex items-center gap-2" style={{ zIndex: 1 }}>
          <div className="flex h-7 items-center gap-0.5 rounded-lg border border-kumo-line bg-kumo-base px-0.5 shadow-sm">
            <button
              ...
              title="Diferenças empilhadas"
              aria-label="Usar diferenças empilhadas"
            ...
            <button
              ...
              title={canSplitDiff ? 'Diferenças lado a lado' : 'Lado a lado precisa de mais espaço'}
              aria-label="Usar diferenças lado a lado"
