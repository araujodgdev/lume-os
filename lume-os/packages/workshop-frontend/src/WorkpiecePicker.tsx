  ...
  return (
    ...
    >
      <button
        ...
        title={expanded ? 'Recolher arquivos' : 'Expandir arquivos'}
        aria-label={expanded ? 'Recolher arquivos' : 'Expandir arquivos'}
      ...
      >
        {expanded && (
          <span className="text-[11px] font-medium uppercase tracking-[0.06em]">Arquivos</span>
        )}
