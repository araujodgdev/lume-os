...
<body>
  <div class="card">
    ...
    <p>Provide the URL of your Home Assistant instance and a long-lived access token. Lume OS will use these to read entity states and control devices.</p>
    ...
    <form method="POST" action="${escapeAttr(params.actionUrl)}">
      ...
      <details>
        ...
        <ol>
          ...
          <li>Give it a name like "Lume OS", then copy the token and paste it above.</li>
        </ol>
      </details>
...
<body style="font-family: system-ui, sans-serif; padding: 2rem; text-align: center;">
  ...
  <p>Home Assistant has been linked to Lume OS. You may close this tab.</p>
</body>
</html>`;
...
<body style="font-family: system-ui, sans-serif; padding: 2rem; text-align: center;">
  ...
  <p>This connection link is invalid or has expired. Please return to Lume OS and start over.</p>
</body>
</html>`;
