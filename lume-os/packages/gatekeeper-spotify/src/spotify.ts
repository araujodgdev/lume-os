...
<html lang="en">
  <body>
    ...
    <p>Authorization complete. You may close this tab and return to Lume OS.</p>
  </body>
</html>`;
...
export default {
  async fetch(req: Request, env: Env, ctx: ExecutionContext): Promise<Response> {
    ...
    if (relPath === "/oauth") {
      ...
      if (error) {
        return new Response("Spotify authorization failed or was denied. Please restart the connection flow from Lume OS.", {
          status: 400,
