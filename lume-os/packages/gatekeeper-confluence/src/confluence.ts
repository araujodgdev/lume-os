...
<p>Authorization complete. You may close this tab and return to Lume OS.</p></body></html>`;
...
const INVALID_LINK_HTML = page("Authorization Link Expired", "#d97706",
  "This authorization link is invalid or has expired. Please return to Lume OS and try again.");
