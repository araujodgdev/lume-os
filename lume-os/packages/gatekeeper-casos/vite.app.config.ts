  ...
  return {
    ...
    closeBundle() {
      ...
      const html = readFileSync(builtHtml, "utf8").replace(
        ...
        "$1$2\n//# sourceURL=app:///gatekeeper/casos/gatekeeper-casos.js\n$3",
      );
      const script = html.match(/<script type="module"[^>]*>([\s\S]*?)<\/script>/)?.[1];
      if (script && errorReporting) {
        writeFileSync(
          resolve(packageDirectory, "dist-app", "gatekeeper-casos.js"),
          `${script}\n//# sourceMappingURL=gatekeeper-casos.js.map\n`,
        );
      }
      const output = resolve(packageDirectory, "src", "generated", "app.txt");
      const contents =
        "<!-- Generated from packages/gatekeeper-casos/app. Do not edit. -->\n" + html;
  ...
  return {
    ...
    build: {
      ...
      rollupOptions: {
        ...
        output: { entryFileNames: "gatekeeper-casos.js" },
      },
      watch: watch
        ? {
