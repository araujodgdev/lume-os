 ...
 */
export const DEFAULT_SITE_NAME = "Lume OS";
...
export type AdminSettingsView = {
  ...
  siteName: string;
  /** Custom deployment logo, or undefined to use the default Lume OS mark. */
...
export interface AdminApi {
   ...
   * image, or undefined after reset. Pass null to restore the default Lume OS mark. The
